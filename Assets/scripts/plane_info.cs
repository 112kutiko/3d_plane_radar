...
public class plane_info : MonoBehaviour
{
    ...
    void convertor()
    {
        ...
        float a = transform.position.y + (Alt*10);
   ...
   public void front_sh() {
        ...
        if (front_show == null)
        {
            ...
            front_show.transform.position -= transform.forward * 127;
            front_show.name = "front_" + Icao;
        }
        else
        {
            front_show.transform.rotation = Quaternion.Euler(0, Trak + 180, 0);
            front_show.transform.position = gameObject.transform.position-transform.forward *127;
            front_show.name = "front_" + Icao;
        }
